class Page80Event {
    ...
    initContent() {
        ...
        this.v80TextBottom.innerHTML = `
            ...
            <p>Литературный фестиваль к 80-летию Победы в Великой отечественной войне <strong>«Книжное эхо войны»</strong> Центральная городская библиотека им. Н. К. Крупской, филиал Библиотека №8.</p>
        `;
    }
