class Page80Event {
    ...
    initLayout() {
        ...
        `;
        this.mainContentText = document.createElement('div')
        this.mainContentText.className = 'main-content__text'
        this.mainContentText.innerHTML = `
            <div class="main-content__column main-content__column-left">
                <img class="main-content__column-image" src="assets/images/80victory/Year_Defender_Fatherland/756513259396705.jpg" alt="" />
                ...
                <p style="text-align: right">
                    <em>В.В. Путин на заседании Госсовета<br /></em><em>20.12.2024<br /></em>
        ...
        this.mainContentInside.appendChild(this.mainContentText);
    }
}
