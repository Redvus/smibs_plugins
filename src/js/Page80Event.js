class Page80Event {
    ...
    initLayout() {
        ...
        this.mainContent.id = 'mainContent80Victory';
    ...
    initContent() {
        ...
        this.footerTop.innerHTML = `
            <img src="/assets/images/80victory/png/v80Soldier.png" />
        `;
        ...
        this.footerTopBottom.innerHTML = `
            <img src="/assets/images/80victory/png/v80LentaMulti.png" />
        `;

        // Mother
        this.imageMain = document.createElement('picture');
        this.imageMain.id = 'imageMother';
        this.imageMain.innerHTML = `
            <img src="/assets/images/80victory/png/v80Mother_2.png" />
        `;

        // Logo
        this.imageLogo = document.createElement('picture');
        this.imageLogo.id = 'imageLogo';
        this.imageLogo.innerHTML = `
            <img src="/assets/images/80victory/png/v80Logo.png" />
        `;

        // Lenta Victory
        this.imageLentaVictory = document.createElement('picture');
        this.imageLentaVictory.id = 'imageLentaVictory';
        this.imageLentaVictory.innerHTML = `
            <img src="/assets/images/80victory/png/v80LentaVictory.png" />
        `;
        ...
        this.imageBrandBook.innerHTML = `
            <a href="https://may9.ru/Brandbook_Pobeda80.pdf" target="_blank">
                <img src="/assets/images/80victory/jpg/v80Brandbook.jpg" />
            </a>
        `;
        ...
        // Top text
        this.mainContentText_1 = document.createElement('div');
        this.mainContentText_1.id = 'v80TextTop';
        this.mainContentText_1.innerHTML = `
            <img class="main-content__column-image" src="assets/images/80victory/jpg/756513259396705.jpg" alt="" />
        ...
        // Bottom text
        this.mainContentText_2 = document.createElement('div');
        this.mainContentText_2.className = 'main-content__text';
        this.mainContentText_2.innerHTML = `
            <div class="main-content__column main-content__column-right">
                ...
                <hr />
                <h4>Мероприятия, планируемые муниципальным бюджетным учреждением культуры городского округа Самара «Самарская муниципальная информационно-библиотечная система» в рамках Года Защитника Отечества.</h4>
                ...
                <a href="https://may9.ru/Brandbook_Pobeda80.pdf" target="_blank">
                    <img class="main-content__column-image" src="assets/images/80victory/Year_Defender_Fatherland/Brandbook_Pobeda80-1.jpg" alt="" />
                </a>
                ...
                <a href="https://may9.ru/" target="_blank">
                    <img class="main-content__column-image" src="assets/images/80victory/Year_Defender_Fatherland/bannerPobeda80.jpg" alt="" />
                </a>
            </div>
        `;

        this.mainContent.appendChild(this.mainContentText_1);
