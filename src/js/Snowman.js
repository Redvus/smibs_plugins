...
class SnowmanGame {
    ...
    initSnowman() {
        ...
        let title_1 =
            '<div class="snowman__title snowman__title--1" id="snowmanTitle1">';
        ...
        this.snowmanTitle.innerHTML = title_1;
    }

    initAnimation() {
        const snowman2026 = document.getElementById("snowman2026"),
            snowmanParts = [...snowman2026.querySelectorAll(".snowman__part")],
            snowmanTitleParts = [
                ...snowman2026.querySelectorAll(".snowman__title_part"),
            ];
