(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const n of e.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerPolicy&&(e.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?e.credentials="include":t.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function a(t){if(t.ep)return;t.ep=!0;const e=s(t);fetch(t.href,e)}})();class d{constructor(){this.initLayout(),this.initContent(),this.initAppends()}initLayout(){this.body=document.body,this.wrapper=document.querySelector(".wrapper"),this.mainContent=document.querySelector(".main-content"),this.mainContentInside=document.querySelector(".main-content__inside"),this.footer=document.createElement("div"),this.footer.className="footer",this.mainContentSubheader=document.createElement("div"),this.mainContentSubheader.className="main-content__subheader",this.mainContentSubheader.innerHTML=`
        ...
        `}initAppends(){document.body.clientWidth>570||screen.width>570?(this.wrapper.appendChild(this.mainContent),this.mainContentInside.appendChild(this.mainContentTop),this.mainContentTop.appendChild(this.imageMain),this.mainContentTop.appendChild(this.imageLentaVictory),this.mainContentTop.appendChild(this.v80TextTop),this.mainContentInside.appendChild(this.mainContentMiddle),this.mainContentMiddle.appendChild(this.v80TextMiddle),this.mainContentMiddle.appendChild(this.brandBook),this.brandBook.appendChild(this.imageBrandBook),this.brandBook.appendChild(this.brandBookText),this.mainContentInside.appendChild(this.mainContentBottom),this.mainContentBottom.appendChild(this.v80TextBottom),this.mainContent.appendChild(this.footerTop)):document.body.clientWidth>1024||screen.width>1024?this.brandBook.removeChild(this.v80Slogan):(document.body.clientWidth<570||screen.width<570)&&(this.wrapper.appendChild(this.mainContent),this.mainContentInside.appendChild(this.mainContentTop),this.mainContentTop.appendChild(this.imageLentaVictory),this.mainContentTop.appendChild(this.v80TextTop),this.mainContentInside.appendChild(this.mainContentMiddle),this.mainContentMiddle.appendChild(this.v80TextMiddle),this.mainContentMiddle.appendChild(this.brandBook),this.brandBook.appendChild(this.imageBrandBook),this.brandBook.appendChild(this.brandBookText),this.mainContentInside.appendChild(this.mainContentBottom),this.mainContentBottom.appendChild(this.v80TextBottom),this.wrapper.appendChild(this.footerTop))}}class r{constructor(){new d}initLayout(){this.body=document.body,this.wrapper=document.querySelector(".wrapper"),this.sidebar=document.createElement("div"),this.sidebar.className="sidebar",this.sidebarStatic=document.createElement("div"),this.sidebarStatic.className="sidebar-static",this.header=document.createElement("div"),this.header.className="header header--desktop",this.header.innerHTML=`
